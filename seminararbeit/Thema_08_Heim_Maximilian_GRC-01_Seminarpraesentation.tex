  ...
  \begin{itemize}
    ...
    \item Gründe:
          \begin{itemize}
            ...
            \item Zuordnung von Zutritt und Zugriff zu Entitäten
          \end{itemize}
    \item Aufgabenbereiche:
          \begin{itemize}
            \item Prozesse (Identitätslebenszyklus)
            \item Technik für Authentifizierung
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Gründe:
          \begin{itemize} \item PoLP/Principle of Least Privilege
  ...
  \begin{itemize}
    \item Produkte von Konzernen wie Microsoft, SAP, IBM, Okta \ldots
          \begin{itemize}
            ...
            \item Implementieren Technologien für optimale Umsetzung: Multi Faktor Authentifizierung (OTP, Biometrie), Single Sign On, SAML, OIDC \ldots
            \item Unterstützen Prozesse: Automatisiertes Lifecycle Management, Risikoanalyse, Audit-Management~\footfullcite{ibm2024verify}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item NIST 800-53A: Kapitel Access Control Family (AC) und Identification and Authentication Family (IA)~\footfullcite{nist202280053a}
    \item ...
  \end{itemize}
\end{frame}
