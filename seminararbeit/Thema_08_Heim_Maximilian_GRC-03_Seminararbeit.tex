...
Im Rahmen der Seminararbeit wurden 7 Forschungsfragen definiert. Die Forschungsfragen sollen die grundlegenden Begriffe des Identitäts- und Berechtigungsmanagements definieren,
\begin{itemize}
  \item Was versteht man unter den Begriffen "Identität" sowie "Identitätsmanagement" und welche Zielstellung wird dabei verfolgt?
  \item Was versteht man unter den Begriffen "Berechtigung" sowie "Berechtigungsmanagement" und welche Zielstellung wird dabei verfolgt?
  ...
  \item Wie wird das Identitäts und Berechtigungsmanagement im Kontext der Sicherheit in der Informationstechnik eingesetzt? (BSI)
