...
\begin{tabularx}{\textwidth}{|c|X|}
  ...
  \hline
  IAM       & Identity Access Management/Identitäts- und Berechtigungsmanagement                 \\
  \hline
  CIAM      & Customer Identity Access Management/Kunden Identitäts- und Berechtigungsmanagement \\
  \hline
  HR        & Human Resources/Personalverwaltung                                                 \\
  \hline
  SSO       & Single Sign On                                                                     \\
  \hline
  SoD       & Separation of Duty/Funktionstrennung                                               \\
  \hline
  IdM       & Identity Management/Identitätsmanagement                                           \\
  \hline
  FIdM      & Federated Identity Management/Föderiertes Identitätsmanagement                     \\
  \hline
  ...
  \hline
  IDaaS     & Identity as a Service/ Cloudbasiertes IdM/IAM                                      \\
  \hline
